class veriticalpage:
    def __init__(self, page):
        ...
        self.r1 = page.locator(
            '(//a[@href="https://www.tranktechnologies.com/ecommerce-web-development-company"])[1]'
        )
        self.r2 = page.locator(
        ...
        self.f1 = page.locator(
            '(//a[@href="https://www.tranktechnologies.com/pos-software-development-company"])[1]')
        self.f2 = page.locator(
            '(//a[@href="https://www.tranktechnologies.com/cryptocurrency-mobile-app-development-company"])[1]' )
